...
class ColorsControllerTest < ActionController::TestCase
  ...
  test "should create color" do
    assert_difference('Color.count') do
      post :create, color: { code: @color.code, description: @color.description, observation: @color.observation }
    end
  ...
  test "should update color" do
    patch :update, id: @color, color: { code: @color.code, description: @color.description, observation: @color.observation }
    assert_redirected_to color_path(assigns(:color))
  end
