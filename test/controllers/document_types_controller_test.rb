...
class DocumentTypesControllerTest < ActionController::TestCase
  ...
  test "should create document_type" do
    assert_difference('DocumentType.count') do
      post :create, document_type: { code: @document_type.code, description: @document_type.description, observation: @document_type.observation }
    end
  ...
  test "should update document_type" do
    patch :update, id: @document_type, document_type: { code: @document_type.code, description: @document_type.description, observation: @document_type.observation }
    assert_redirected_to document_type_path(assigns(:document_type))
  end
