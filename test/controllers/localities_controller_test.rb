...
class LocalitiesControllerTest < ActionController::TestCase
  ...
  test "should create locality" do
    assert_difference('Locality.count') do
      post :create, locality: { code: @locality.code, description: @locality.description, observation: @locality.observation, province_id: @locality.province_id }
    end
  ...
  test "should update locality" do
    patch :update, id: @locality, locality: { code: @locality.code, description: @locality.description, observation: @locality.observation, province_id: @locality.province_id }
    assert_redirected_to locality_path(assigns(:locality))
  end
