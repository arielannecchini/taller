...
class ProvincesControllerTest < ActionController::TestCase
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post :create, province: { code: @province.code, country_id: @province.country_id, description: @province.description }
    end
  ...
  test "should update province" do
    patch :update, id: @province, province: { code: @province.code, country_id: @province.country_id, description: @province.description }
    assert_redirected_to province_path(assigns(:province))
  end
