...
class TelephoneTypesControllerTest < ActionController::TestCase
  ...
  test "should create telephone_type" do
    assert_difference('TelephoneType.count') do
      post :create, telephone_type: { code: @telephone_type.code, description: @telephone_type.description, observation: @telephone_type.observation }
    end
  ...
  test "should update telephone_type" do
    patch :update, id: @telephone_type, telephone_type: { code: @telephone_type.code, description: @telephone_type.description, observation: @telephone_type.observation }
    assert_redirected_to telephone_type_path(assigns(:telephone_type))
  end
