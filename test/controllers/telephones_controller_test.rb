...
class TelephonesControllerTest < ActionController::TestCase
  ...
  test "should create telephone" do
    assert_difference('Telephone.count') do
      post :create, telephone: { contact: @telephone.contact, observation: @telephone.observation, telephone: @telephone.telephone, telephone_type_id: @telephone.telephone_type_id }
    end
  ...
  test "should update telephone" do
    patch :update, id: @telephone, telephone: { contact: @telephone.contact, observation: @telephone.observation, telephone: @telephone.telephone, telephone_type_id: @telephone.telephone_type_id }
    assert_redirected_to telephone_path(assigns(:telephone))
  end
