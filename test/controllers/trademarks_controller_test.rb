...
class TrademarksControllerTest < ActionController::TestCase
  ...
  test "should create trademark" do
    assert_difference('Trademark.count') do
      post :create, trademark: { code: @trademark.code, description: @trademark.description, observation: @trademark.observation }
    end
  ...
  test "should update trademark" do
    patch :update, id: @trademark, trademark: { code: @trademark.code, description: @trademark.description, observation: @trademark.observation }
    assert_redirected_to trademark_path(assigns(:trademark))
  end
